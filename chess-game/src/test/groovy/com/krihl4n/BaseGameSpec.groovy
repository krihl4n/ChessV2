...
class BaseGameSpec extends BaseSpec {
    ...
    void setupTests(GameMode mode) {
        ...
        CommandFactory commandFactory = new com.krihl4n.moveCommands.CommandFactory.CommandFactory(positionTracker, new MoveLabelGenerator(checkEvaluator, positionTracker, pieceMoveCalculator))
